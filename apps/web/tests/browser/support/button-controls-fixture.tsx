...
type Mode = "invite" | "preferences" | "sessions" | "search" | "security" | "group" | "new-chat" | "protected" | "contacts";

const calls = {
  invites: [] as string[],
  phoneUpdates: [] as string[],
  syncedPhones: [] as string[][],
...
const directConversation = {
  ...
  members: [
    { id: "me", display_name: me.display_name, phone_e164: me.phone_e164, email: me.email, role: "owner", last_read_sequence: 0 },
    peer,
  ],
...
api.createInvite = async (phone: string) => {
  ...
  return { id: "invite-id", token: "invite-token", phone_e164: phone, email: null, expires_at: "2026-09-30T00:00:00Z", max_uses: 1 };
};
api.updatePhone = async (phone: string) => {
