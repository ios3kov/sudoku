...
Physical iPhone acceptance, absence of the lower seam, VoiceOver/Dynamic Type acceptance, two-device messaging and production readiness remain open. Neither this checkpoint nor local compilation marks those gates complete.
